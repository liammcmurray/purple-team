...
router.post('/sis-team', function (req, res) {
...
// router.post('/sub-offence', function (req, res) {
  ...
  // Make a variable and give it the value from 'team'
 //  var subCrime = req.session.data['sub-offence-source']
   //    DocIDPCrime = req.session.data['start-crime']

  // Check whether the variable matches a condition
  // if (subCrime === 'sub-no' && DocIDPCrime === 'document-fraud'){
 //    res.redirect('/purple/current/start/idp.html');
 //  }
  // if (subCrime === 'sub-no' && DocIDPCrime === 'idp'){
