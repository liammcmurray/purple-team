...
// SIS - Smuggling - vehicles
router.post('/sis-smug-vehicles', function (req, res) {

  // Make a variable and give it the value
  var smugglingTransport = req.session.data['sis-smuggling-transport']

  // Check whether the variable matches a condition
  if (smugglingTransport == 'yes'){
